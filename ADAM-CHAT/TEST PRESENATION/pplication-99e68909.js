...
function cleanMessages(e) {
    $(".messages").html('<div class="message"></div>'), $(".messages > .message").replaceWith(_.template('{{ _.forEach(messages, function(message) { }}<div class="message animated">{{= message }}</div>{{ }); }}')({
        messages: examples[e].messages
    })), $(".messages > .message:nth-child(2n)").addClass("to"), $(".messages > .message:nth-child(2n+1)").addClass("from")
}

function showSms(e) {
    setTimeout(function() {
        $(".messages > .message:nth-child(" + (e + 1) + ")").addClass("fadeInUp")
    }, baseTimeoutInterval * e)
}

function changeExample(e) {
    mobileView() ? setTimeout(function() {
        $(".headline .carousel").slick("slickNext")
    }, baseTimeoutInterval * e) : setTimeout(function() {
        var t = examples[e].messages.length;
        cleanMessages(e);
        for (var n = 0; t > n; n++) showSms(n);
        setTimeout(function() {
            $(".headline .carousel").slick("slickNext")
        }, 4 * baseTimeoutInterval)
    }, 4 * baseTimeoutInterval * e)
}
...
function carousel() {
    $(".headline .carousel div").replaceWith(_.template("{{ _.forEach(headlines, function(headline) { }}<div>{{= headline }}</div>{{ }); }}")({
        headlines: _.map(examples, "headline")
    })), $(".headline .carousel").slick({
        vertical: !0,
        arrows: !1
    });
    var e = mobileView() ? baseTimeoutInterval * examples.length : baseTimeoutInterval * (examples.length * numberOfMessagesByExample);
...
function showFooterOnScroll() {
    $(window).scroll(function() {
        $(document).scrollTop() > 2 * $(window).height() / 3 ? $(".fixed-footer").addClass("show") : $(".fixed-footer").removeClass("show")
    })
}
...
function loadCommunities(e) {
    $(".school").prop("disabled", !0), $(".diploma").prop("disabled", !0);
    var t = $.ajax({
    ...
    t.done(function(e) {
        $(".school").prop("disabled", !1), $(".diploma").prop("disabled", !1), $(".school").select2({
            allowClear: !0,
...
function registrationSuccess(e) {
    user = e, trackEvent("Registration", "success", "Success registration"), fbq("track", "CompleteRegistration"), identifyUser(e.id), loadCommunities(e), $("#myModal").modal(), $("form#user_registration_footer").fadeOut("slow", function() {
        $(".registration-success").fadeIn("slow")
    }), $("form#user_registration").fadeOut("slow", function() {
        $(".registration-success").fadeIn("slow")
    })
}
...
function initializeAnalyticsTracking() {
    ...
    $(window).on("scroll", function() {
        e || (trackEvent("Scroll", "begin", "Beginning of scrolling"), e = !0), $(window).scrollTop() + $(window).height() == $(document).height() && trackEvent("Scroll", "bottom", "Scroll to bottom")
    }), $("form#user_registration .user_phone").on("focus", function() {
        trackEvent("Focus", "main_form", "Focus on main input")
    }), $("form#extra_informations .school").on("select2:open", function() {
        trackEvent("Focus", "extra_informations_form", "Focus on school input")
    }), $("form#extra_informations .diploma").on("select2:open", function() {
    ...
    }), $("form#user_registration_footer .user_phone").on("focus", function() {
...
function onUserRegistration(e) {
    ...
    if (n) {
        ...
        var i = $.ajax({
            ...
            data: {
                user: {
                    phone: t.find(".user_phone").val()
                }
            }
        });
        trackEvent("Registration", "perform", "Perform a registration"), i.done(registrationSuccess), i.fail(function(e, t) {
            trackEvent("Registration", "fail", "Fail registration"), e.responseJSON && e.responseJSON.errors ? alert(e.responseJSON.errors[0]) : alert("Oops, quelque chose s'est mal pass\xe9, r\xe9essaye plus tard !")
        }), i.always(function() {
    ...
    function w(e) {
        var t = K,
            n = He[e];
        return n || (n = b(e, t), "none" !== n && n || (Me = (Me || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Me[0].contentDocument, t.write(), t.close(), n = b(e, t), Me.detach()), He[e] = n), n
    }

    function x(e, t, n) {
        var i, r, o, s, a = e.style;
        return n = n || ze(e), n && (s = n.getPropertyValue(t) || n[t]), n && ("" !== s || Z.contains(e.ownerDocument, e) || (s = Z.style(e, t)), Ue.test(s) && Fe.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function C(e, t, n) {
        ...
        if (0 >= r || null == r) {
            if (r = x(e, t, o), (0 > r || null == r) && (r = e.style[t]), Ue.test(r)) return r;
    ...
    function D(e, t, n) {
        ...
        if (Z.isEmptyObject(p)) "inline" === ("none" === c ? w(e.nodeName) : c) && (f.display = c);
            ...
            g ? "hidden" in g && (h = g.hidden) : g = me.access(e, "fxshow", {}), o && (g.hidden = !h), h ? Z(e).show() : d.done(function() {
                Z(e).hide()
            }), d.done(function() {
                var t;
                me.remove(e, "fxshow");
        ...
        function(e) {
            ...
            x = t.support = {}, k = t.isXML = function(e) {
                ...
                return i !== D && 9 === i.nodeType && i.documentElement ? (D = i, N = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", $e, !1) : n.attachEvent && n.attachEvent("onunload", $e)), I = !k(i), x.attributes = r(function(e) {
                    ...
                    return N.appendChild(e).id = M, !i.getElementsByName || !i.getElementsByName(M).length
            ...
            return d.prototype = _.filters = _.pseudos, _.setFilters = new d, T = t.tokenize = function(e, n) {
                ...
                if (n = n || [], 1 === d.length) {
                    if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && x.getById && 9 === t.nodeType && I && _.relative[o[1].type]) {
            ...
            }, x.sortStable = M.split("").sort(V).join("") === M, x.detectDuplicates = !!j, O(), x.sortDetached = r(function(e) {
    ...
    Z.Callbacks = function(e) {
        ...
        when: function(e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), i = new Array(s); s > r; r++) o[r] && Z.isFunction(o[r].promise) ? o[r].promise().done(c(r, i, o)).fail(l.reject).progress(c(r, n, t)) : --a;
        ...
        add: function(e, t, n, i, r) {
            ...
            if (v)
                for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = Z.guid++), (l = v.events) || (l = v.events = {}), (s = v.handle) || (s = v.handle = function(t) {
                    ...
                    }), t = (t || "").match(fe) || [""], c = t.length; c--;) a = Ee.exec(t[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (d = Z.event.special[f] || {}, f = (r ? d.delegateType : d.bindType) || f, d = Z.event.special[f] || {}, u = Z.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
        ...
        remove: function(e, t, n, i, r) {
            ...
            if (v && (l = v.events)) {
                for (t = (t || "").match(fe) || [""], c = t.length; c--;)
                    if (a = Ee.exec(t[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
    ...
    Z.extend({
        ...
        css: function(e, t, n, i) {
            var r, o, s, a = Z.camelCase(t);
            return t = Z.cssProps[a] || (Z.cssProps[a] = $(e.style, a)), s = Z.cssHooks[t] || Z.cssHooks[a], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = x(e, t, i)), "normal" === r && t in Xe && (r = Xe[t]), "" === n || n ? (o = parseFloat(r), n === !0 || Z.isNumeric(o) ? o || 0 : r) : r
        }
        ...
        toggle: function(e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() {
                $e(this) ? Z(this).show() : Z(this).hide()
            })
        }
    ...
    Z.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((e || d.url || xt) + "").replace(dt, "").replace(vt, _t[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = Z.trim(d.dataType || "*").toLowerCase().match(fe) || [""], null == d.crossDomain && (l = mt.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === _t[1] && l[2] === _t[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (_t[3] || ("http:" === _t[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = Z.param(d.data, d.traditional)), L(yt, d, t, x), 2 === b) return x;
    ...
    Z.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Z(this).is(":disabled") && St.test(this.nodeName) && !Ct.test(e) && (this.checked || !ke.test(e))
            }).map(function(e, t) {
                var n = Z(this).val();
...
function() {
    ...
    function x(g) {
        ...
        function xt(e, t, n, i, r, o, s) {
            ...
            var l = Ea(e);
            if (l) {
                if (a = Yn(e), !t) return nt(e, a)
            } else {
                var c = is.call(e),
                    u = c == Y;
                if (c != G && c != U && (!u || r)) return He[c] ? Jn(e, c, t) : r ? e : {};
                if (a = Xn(u ? {} : e), !t) return mt(a, e)
            }
            o || (o = []), s || (s = []);
        ...
        function Lt(e, t, n, i, r, o, s) {
            var a = Ea(e),
                ...
                c = z,
                u = z;
            a || (c = is.call(e), c == U ? c = G : c != G && (a = zr(e))), l || (u = is.call(t), u == U ? u = G : u != G && (l = zr(t)));
            var d = c == G,
                p = u == G,
                f = c == u;
            ...
            return e = pi(e),
                function(o) {
                    ...
                    if (o = di(o), (n || !i) && !(s in o)) {
                        if (o = 1 == e.length ? o : It(o, Xt(e, 0, -1)), null == o) return !1;
                        s = Ci(e), o = di(o)
                    }
        ...
        function Ft(e, t, n, i, r) {
            if (!Ir(e)) return e;
            var o = Kn(t) && (Ea(t) || zr(t)),
                s = o ? _ : Ha(t);
            return it(s || t, function(a, l) {
                if (s && (l = a, a = t[l]), h(a)) i || (i = []), r || (r = []), Ut(e, t, l, Ft, n, i, r);
                else {
                    var c = e[l],
                        u = n ? n(c, a, l, e, t) : _,
                        d = u === _;
        ...
        function Ut(e, t, n, i, r, o, s) {
            for (var a = o.length, l = t[n]; a--;)
                if (o[a] == l) return void(e[n] = s[a]);
            var c = e[n],
                u = r ? r(c, l, n, e, t) : _,
                d = u === _;
            d && (u = l, Kn(l) && (Ea(l) || zr(l)) ? u = Ea(c) ? c : Kn(c) ? nt(c) : [] : Hr(l) || Tr(l) ? u = Tr(c) ? Xr(c) : Hr(c) ? c : {} : d = !1), o.push(l), s.push(u), d ? e[n] = i(u, l, r, o, s) : (u === u ? u !== c : c === c) && (e[n] = u)
        }
        ...
        function tn(e, t, n, i) {
            for (var r = e.length, o = i ? r : -1;
                (i ? o-- : ++o < r) && t(e[o], o, e););
            return n ? Xt(e, i ? 0 : o, i ? o + 1 : r) : Xt(e, i ? o + 1 : 0, i ? r : o)
        }
        ...
        function kn(e) {
            return function() {
                ...
                for (i = t ? -1 : n; ++i < n;) {
                    ...
                    var a = Un(s),
                        l = "wrapper" == a ? Fs(s) : _;
                    t = l && ti(l[0]) && l[1] == (O | S | E | D) && !l[4].length && 1 == l[9] ? t[Un(l[0])].apply(t, l[3]) : 1 == s.length && ti(s) ? t[a]() : t.thru(s)
                }
                return function() {
                    var e = arguments,
                        i = e[0];
                    if (t && 1 == e.length && Ea(i) && i.length >= R) return t.plant(i).value();
        ...
        function On(e, t) {
            return function(n, i, r, o) {
                ...
                return "function" == typeof i && o === _ && Ea(n) ? e(n, i, r, s) : Yt(n, Fn(i, o, 4), r, s, t)
            }
        }
                ...
                if (i && (x = ln(x, i, r)), o && (x = cn(x, o, s)), h || m) {
                    ...
                    if (b -= C.length, c > b) {
                        ...
                        var P = [e, t, n, N, O, I, D, S, l, A],
                            L = Dn.apply(_, P);
                        return ti(e) && zs(L, P), L.placeholder = $, L
                    }
                }
                var R = p ? n : this,
                    q = f ? R[e] : e;
        ...
        function Nn(e, t, n) {
            ...
            var r = t - i;
            return n = null == n ? " " : n + "", mo(n, vs(r / n.length)).slice(0, r)
        }
        ...
        function Xn(e) {
            var t = e.constructor;
            return "function" == typeof t && t instanceof t || (t = Yo), new t
        }
        ...
        function Gn(e, t, n) {
            null == e || ei(t, e) || (t = pi(t), e = 1 == t.length ? e : It(e, Xt(t, 0, -1)), t = Ci(t));
            var i = null == e ? e : e[t];
        ...
        function ui(e) {
            return null == e ? [] : Kn(e) ? Ir(e) ? e : Yo(e) : oo(e)
        }
        ...
        function pi(e) {
            if (Ea(e)) return e;
            var t = [];
            return r(e).replace($e, function(e, n, i, r) {
        ...
        function hi(e, t, n) {
            ...
            for (var i = 0, r = e ? e.length : 0, o = -1, s = Fo(vs(r / t)); r > i;) s[++o] = Xt(e, i, i += t);
            return s
        }
        ...
        function vi(e, t, n) {
            var i = e ? e.length : 0;
            return i ? ((n ? Zn(e, t, n) : null == t) && (t = 1), Xt(e, 0 > t ? 0 : t)) : []
        }

        function mi(e, t, n) {
            var i = e ? e.length : 0;
            return i ? ((n ? Zn(e, t, n) : null == t) && (t = 1), t = i - (+t || 0), Xt(e, 0, 0 > t ? 0 : t)) : []
        }
        ...
        function Ai() {
            ...
            for (var n = 0, i = zn(), r = e.length; ++n < r;)
                for (var o = 0, s = e[n];
        ...
        function Oi(e, t, n) {
            var i = e ? e.length : 0;
            return i ? (n && "number" != typeof n && Zn(e, t, n) && (t = 0, n = i), Xt(e, t, n)) : []
        }

        function Di(e, t, n) {
            var i = e ? e.length : 0;
            return i ? ((n ? Zn(e, t, n) : null == t) && (t = 1), Xt(e, 0, 0 > t ? 0 : t)) : []
        }

        function Ni(e, t, n) {
            var i = e ? e.length : 0;
            return i ? ((n ? Zn(e, t, n) : null == t) && (t = 1), t = i - (+t || 0), Xt(e, 0 > t ? 0 : t)) : []
        }
        ...
        function Li(e, t, i, r) {
            ...
            var s = Fn();
            return (null != i || s !== wt) && (i = s(i, r, 3)), t && zn() === n ? m(e, i) : Zt(e, i)
        }
        ...
        function Ri(e) {
            ...
            for (var i = Fo(n); ++t < n;) i[t] = lt(e, zt(t));
            return i
        }
        ...
        function Zi(e, t, n, i) {
            var r = e ? Us(e) : 0;
            return ni(r) || (e = oo(e), r = e.length), n = "number" != typeof n || i && Zn(t, n, i) ? 0 : 0 > n ? _s(r + n, 0) : n || 0, "string" == typeof e || !Ea(e) && Ur(e) ? r >= n && e.indexOf(t, n) > -1 : !!r && zn(e, t, n) > -1
        }
        ...
        function Er(e) {
            return null == e ? !0 : Kn(e) && (Ea(e) || Ur(e) || Tr(e) || h(e) && Nr(e.splice)) ? !e.length : !Ha(e).length
        }
        ...
        function Mr(e) {
            return "number" == typeof e || h(e) && is.call(e) == J
        }
        ...
        function Qr(e, t) {
            ...
            var n = ts.call(e, t);
            if (!n && !ei(t)) {
                if (t = pi(t), e = 1 == t.length ? e : It(e, Xt(t, 0, -1)), null == e) return !1;
        ...
        function no(e, t, n) {
            var i = null == e ? _ : e[t];
            return i === _ && (null == e || ei(t, e) || (t = pi(t), e = 1 == t.length ? e : It(e, Xt(t, 0, -1)), i = null == e ? _ : e[Ci(t)]), i = i === _ ? n : i), Nr(i) ? i.call(e) : i
        }
        ...
        function lo(e, t, n) {
            ...
            if (null == n && (r && "boolean" == typeof e ? (n = e, e = 1) : "boolean" == typeof t && (n = t, r = !0)), i && r && (t = 1, r = !1), e = +e || 0, r ? (t = e, e = 0) : t = +t || 0, n || e % 1 || t % 1) {
                var o = Cs();
                return $s(e + o * (t - e + ls("1e-" + ((o + "").length - 1))), t)
            }
            return Vt(e, t)
        }
        ...
        function uo(e) {
            return e = r(e), e && e.replace(Ne, c).replace(Ce, "")
        }
        ...
        function $o(e, t, n) {
            ...
            if (Fr(s)) {
                if (e.slice(a).search(s)) {
                    ...
                    for (s.global || (s = Xo(s.source, (Ee.exec(s) || "") + "g")), s.lastIndex = 0; c = s.exec(d);) u = c.index;
        ...
        var Fo = g.Array,
            ...
            is = Qo.toString,
            rs = Ze._,
            os = Xo("^" + es.call(ts).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
            ss = g.ArrayBuffer,
            as = g.clearTimeout,
            ls = g.parseFloat,
            cs = Bo.pow,
        ...
        var Ps = function() {
            ...
            Vs = _n(!0),
            Ys = mr(function(e) {
                for (var t = e.length, i = t, r = Fo(d), o = zn(), s = o === n, a = []; i--;) {
            ...
            Ea = bs || function(e) {
                return h(e) && ni(e.length) && is.call(e) == z
            },
            ja = dn(Ft),
            ...
            il = wn(Br, As),
            rl = Pn("round");
        return X.prototype = Q.prototype, ee.prototype = Ps(Q.prototype), ee.prototype.constructor = ee, Fe.prototype = Ps(Q.prototype), Fe.prototype.constructor = Fe, Be.prototype["delete"] = Ve, Be.prototype.get = Ye, Be.prototype.has = Xe, Be.prototype.set = Je, Ge.prototype.push = Qe, hr.Cache = Be, X.after = ur, X.ary = dr, X.assign = Oa, X.at = na, X.before = pr, X.bind = va, X.bindAll = ma, X.bindKey = ya, X.callback = Co, X.chain = Fi, X.chunk = hi, X.compact = gi, X.constant = So, X.countBy = ia, X.create = Jr, X.curry = ba, X.curryRight = wa, X.debounce = fr, X.defaults = Da, X.defaultsDeep = Na, X.defer = xa, X.delay = _a, X.difference = Ws, X.drop = vi, X.dropRight = mi, X.dropRightWhile = yi, X.dropWhile = bi, X.fill = wi, X.filter = Ki, X.flatten = _i, X.flattenDeep = $i, X.flow = $a, X.flowRight = ka, X.forEach = sa, X.forEachRight = aa, X.forIn = La, X.forInRight = Ra, X.forOwn = qa, X.forOwnRight = Ma, X.functions = Gr, X.groupBy = la, X.indexBy = ca, X.initial = Ti, X.intersection = Ys, X.invert = Zr, X.invoke = ua, X.keys = Ha, X.keysIn = eo, X.map = er, X.mapKeys = Fa, X.mapValues = Ua, X.matches = Eo, X.matchesProperty = jo, X.memoize = hr, X.merge = ja, X.method = Qa, X.methodOf = Za, X.mixin = Oo, X.modArgs = Ta, X.negate = gr, X.omit = za, X.once = vr, X.pairs = to, X.partial = Ca, X.partialRight = Sa, X.partition = da, X.pick = Wa, X.pluck = tr, X.property = Io, X.propertyOf = Po, X.pull = Ai, X.pullAt = Xs, X.range = Lo, X.rearg = Aa, X.reject = nr, X.remove = Ei, X.rest = ji, X.restParam = mr, X.set = io, X.shuffle = rr, X.slice = Oi, X.sortBy = ar, X.sortByAll = ha, X.sortByOrder = lr, X.spread = yr, X.take = Di, X.takeRight = Ni, X.takeRightWhile = Ii, X.takeWhile = Pi, X.tap = Ui, X.throttle = br, X.thru = zi, X.times = Ro, X.toArray = Yr, X.toPlainObject = Xr, X.transform = ro, X.union = Ks, X.uniq = Li, X.unzip = Ri, X.unzipWith = qi, X.values = oo, X.valuesIn = so, X.where = cr, X.without = Qs, X.wrap = wr, X.xor = Mi, X.zip = Zs, X.zipObject = Hi, X.zipWith = ea, X.backflow = ka, X.collect = er, X.compose = ka, X.each = sa, X.eachRight = aa, X.extend = Oa, X.iteratee = Co, X.methods = Gr, X.object = Hi, X.select = Ki, X.tail = ji, X.unique = Li, Oo(X, X), X.add = Mo, X.attempt = Ka, X.camelCase = Ba, X.capitalize = co, X.ceil = el, X.clone = xr, X.cloneDeep = _r, X.deburr = uo, X.endsWith = po, X.escape = fo, X.escapeRegExp = ho, X.every = Gi, X.find = ra, X.findIndex = Bs, X.findKey = Ia, X.findLast = oa, X.findLastIndex = Vs, X.findLastKey = Pa, X.findWhere = Qi, X.first = xi, X.floor = tl, X.get = Kr, X.gt = $r, X.gte = kr, X.has = Qr, X.identity = Ao, X.includes = Zi, X.indexOf = ki, X.inRange = ao, X.isArguments = Tr, X.isArray = Ea, X.isBoolean = Cr, X.isDate = Sr, X.isElement = Ar, X.isEmpty = Er, X.isEqual = jr, X.isError = Or, X.isFinite = Dr, X.isFunction = Nr, X.isMatch = Pr, X.isNaN = Lr, X.isNative = Rr, X.isNull = qr, X.isNumber = Mr, X.isObject = Ir, X.isPlainObject = Hr, X.isRegExp = Fr, X.isString = Ur, X.isTypedArray = zr, X.isUndefined = Wr, X.kebabCase = Va, X.last = Ci, X.lastIndexOf = Si, X.lt = Br, X.lte = Vr, X.max = nl, X.min = il, X.noConflict = Do, X.noop = No, X.now = ga, X.pad = go, X.padLeft = Ya, X.padRight = Xa, X.parseInt = vo, X.random = lo, X.reduce = pa, X.reduceRight = fa, X.repeat = mo, X.result = no, X.round = rl, X.runInContext = x, X.size = or, X.snakeCase = Ja, X.some = sr, X.sortedIndex = Js, X.sortedLastIndex = Gs, X.startCase = Ga, X.startsWith = yo, X.sum = Ho, X.template = bo, X.trim = wo, X.trimLeft = xo, X.trimRight = _o, X.trunc = $o, X.unescape = ko, X.uniqueId = qo, X.words = To, X.all = Gi, X.any = sr, X.contains = Zi, X.eq = jr, X.detect = ra, X.foldl = pa, X.foldr = fa, X.head = xi, X.include = Zi, X.inject = pa, Oo(X, function() {
            var e = {};
            return Ot(X, function(t, n) {
                X.prototype[n] || (e[n] = t)
            }), e
        }(), !1), X.sample = ir, X.prototype.sample = function(e) {
            return this.__chain__ || null != e ? this.thru(function(t) {
                return ir(t, e)
            }) : ir(this.value())
        }, X.VERSION = $, it(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function(e) {
            X[e].placeholder = X
            ...
            var n = /^(?:filter|map|reject)|While$/.test(t),
                i = /^(?:first|last)$/.test(t),
                r = X[i ? "take" + ("last" == t ? "Right" : "") : t];
            r && (X.prototype[t] = function() {
                var t = i ? [1] : arguments,
                    o = this.__chain__,
                    s = this.__wrapped__,
            ...
            name: "wrapper",
            func: _
        }], Fe.prototype.clone = Ue, Fe.prototype.reverse = ze, Fe.prototype.value = We, X.prototype.chain = Wi, X.prototype.commit = Bi, X.prototype.concat = ta, X.prototype.plant = Vi, X.prototype.reverse = Yi, X.prototype.toString = Xi, X.prototype.run = X.prototype.toJSON = X.prototype.valueOf = X.prototype.value = Ji, X.prototype.collect = X.prototype.map, X.prototype.head = X.prototype.first, X.prototype.select = X.prototype.filter, X.prototype.tail = X.prototype.rest, X
    }
    var _, $ = "3.10.1",
        k = 1,
        T = 2,
        ...
        qe = -1,
        Me = {};
    Me[ne] = Me[ie] = Me[re] = Me[oe] = Me[se] = Me[ae] = Me[le] = Me[ce] = Me[ue] = !0, Me[U] = Me[z] = Me[te] = Me[W] = Me[B] = Me[V] = Me[Y] = Me[X] = Me[J] = Me[G] = Me[K] = Me[Q] = Me[Z] = Me[ee] = !1;
    var He = {};
    He[U] = He[z] = He[te] = He[W] = He[B] = He[ne] = He[ie] = He[re] = He[oe] = He[se] = He[J] = He[G] = He[K] = He[Z] = He[ae] = He[le] = He[ce] = He[ue] = !0, He[V] = He[Y] = He[X] = He[Q] = He[ee] = !1;
    var Fe = {
            "\xc0": "A",
            "\xc1": "A",
            "\xc2": "A",
    ...
    function(e) {
        ...
        function n(e, n) {
            return J(n) && (n = t(e ? e._d ? e : t(o, e) : o, n), n._d = 1), n
        }
        ...
        function h(e) {
            var t, n = this,
                i = n.linkCtx,
                r = (n.ctx || {})[e];
            return void 0 === r && i && i.ctx && (r = i.ctx[e]), void 0 === r && (r = Z[e]), r && J(r) && !r._wrp && (t = function() {
                return r.apply(this && this !== U ? this : n, arguments)
            }, t._wrp = !0, c(t, r)), t || r
        }
        ...
        function g(e, t, n, r) {
            ...
            return void 0 !== r ? n = r = {
                props: {},
                args: [r]
            } : a && (n = a(t.data, t, X)), s = n.args[0], (e || a) && (o = l && l.tag, o || (o = c(new te._tg, {
                _: {
                    inline: !l,
                    bnd: a,
                    unlinked: !0
                ...
                flow: !0,
                tagCtx: n
            }), l && (l.tag = o, o.linkCtx = l), n.ctx = R(n.ctx, (l ? l.view : t).ctx)), o._er = r && s, i(o, n), n.view = t, o.ctx = n.ctx || {}, n.ctx = void 0, t._.tag = o, s = o.cvtArgs(o.convert || "true" !== e && e)[0], s = a && t._.onRender ? t._.onRender(s, t, a) : s, t._.tag = void 0), void 0 != s ? s : ""
        }
        ...
        function x(e, t, i) {
            ...
            return void 0 !== (o = l.template) && (l.template = "" + o === o ? K[o] || K(o) : o), l.init !== !1 && ((r.prototype = l).constructor = l._ctr = r), i && (l._parentTmpl = i), l
        }
        ...
        function S(e, t, n, i, r, o) {
            ...
            if (t === !0 ? (n = t, t = void 0) : typeof t !== Te && (t = void 0), (l = this.tag) ? (u = this, c = l._.tmpl || u.tmpl, h = h || u.view, arguments.length || (e = h)) : c = this, c) {
                if (!h && e && "view" === e._is && (h = e), h && e === h && (e = h.data), c.fn || (c = l._.tmpl = K[c] || K(c)), d = !h, ie = ie || d, h || ((t = t || {}).root = e), !ie || ne.useViews || c.useViews || h && h !== Y) g = A(c, e, t, n, h, r, o, l);
                else {
                    if (h ? (p = h.data, f = h.index, h.index = Ae) : (h = Y, h.data = e, h.ctx = t), G(e) && !n)
                        for (s = 0, a = e.length; a > s; s++) h.index = s, h.data = e[s], g += c.fn(e[s], h, X);
                    else g += c.fn(e, h, X);
                    h.data = p, h.index = f
                }
                d && (ie = void 0)
        ...
        function A(e, t, n, i, r, o, s, a) {
            ...
            if (a && (y = a.tagName, _ = a.tagCtx, n = n ? R(n, a.ctx) : a.ctx, v = _.content, _.props.link === !1 && (n = n || {}, n.link = !1), (w = _.props.itemVar) && ("~" !== w.charAt(0) && j("Use itemVar='~myItem'"), w = w.slice(1))), r && (v = v || r.content, s = s || r._.onRender, n = R(n, r.ctx)), o === !0 && (g = !0, o = 0), s && (n && n.link === !1 || a && a._.noVws) && (s = void 0), m = s, s === !0 && (m = void 0, s = r._.onRender), n = e.helpers ? R(e.helpers, n) : n, x = n, G(t) && !i)
                for (p = g ? r : void 0 !== o && r || new b(n, "array", r, t, e, o, v, s), w && (p.it = w), w = p.it, u = 0, d = t.length; d > u; u++) w && l(t[u]), f = new b(x, "item", p, t[u], e, (o || 0) + u, v, s), h = e.fn(t[u], f, X), $ += p._.onRender ? p._.onRender(h, f) : h;
            else w && l(t), p = g ? r : new b(x, y || "data", r, t, e, o, v, s), a && !a.flow && (p.tag = a), $ += e.fn(t, p, X);
            return m ? m($, p) : $
        }
        ...
        function O(e, t, n, i, r) {
            function o(t) {
                t -= f, t && g.push(e.substr(f, t).replace(pe, "\\n"))
            }
            ...
            function a(a, l, p, m, y, b, w, x, _, $, k, T) {
                ...
                var C = (l || n) && [
                    ...
                    R = "",
                    q = !$ && !y && !w;
                p = p || (_ = _ || "#data", y), o(T), f = T + a.length, x ? d && g.push(["*", "\n" + _.replace(/^:/, "ret+= ").replace(fe, "$1") + ";\n"]) : p ? ("else" === p && (ve.test(_) && j('for "{{else if expr}}" use "{{else expr}}"'), C = v[7] && [
                    []
                ], v[8] = e.substring(v[8], T), v = h.pop(), g = v[2], q = !0), _ && P(_.replace(pe, " "), C, t).replace(ge, function(e, t, n, i, r, o, s, a) {
            ...
            function i(i, m, y, b, w, x, _, $, k, T, C, S, A, E, D, N, I, P, L, R) {
                function q(e, n, i, s, a, l, d, p) {
                    ...
                    if (i && (w = w.slice(n.length), f || (e = (s ? 'view.hlp("' + s + '")' : a ? "view" : "data") + (p ? (l ? "." + l : s ? "" : a ? "" : "." + i) + (d || "") : (p = s ? "" : a ? l || "" : i, "")), e += p ? "." + p : "", e = n + ("view.data" === e.slice(0, 9) ? e.slice(5) : e)), c)) {
                        if (F = "linkTo" === r ? o = t._jsvto = t._jsvto || [] : u.bd, U = f && F[F.length - 1]) {
                            if (U._jsv) {
                                for (; U.sb;) U = U.sb;
                                U.bnd && (w = "^" + w.slice(1)), U.sb = w, U.bnd = U.bnd || "^" === w.charAt(0)
                            }
                        } else F.push(w);
                        v[h] = L + (f ? 1 : 0)
                    }
                ...
                if (!_ || l || a) {
                    if (c && N && !l && !a && (!r || s || o) && (M = v[h - 1], R.length - 1 > L - (M || 0))) {
                        if (M = R.slice(M, L + i.length), H !== !0)
                            if (F = o || d[h - 1].bd, U = F[F.length - 1], U && U.prm) {
                        ...
                        N = se + ":" + M + " onerror=''" + ae, H = f[N], H || (f[N] = !0, f[N] = H = O(N, n, !0)), H !== !0 && z && (z._jsv = H, z.prm = u.bd, z.bnd = z.bnd || z.path && z.path.indexOf("^") >= 0)
                    }
                    return l ? (l = !A, l ? i : S + '"') : a ? (a = !E, a ? i : S + '"') : (y ? (v[h] = L++, u = d[++h] = {
                        bd: []
                    }, y) : "") + (P ? h ? "" : (p = R.slice(p, L), (r ? (r = s = o = !1, "\b") : "\b,") + p + (p = L + i.length, c && t.push(u.bd = []), "\b")) : $ ? (h && j(e), c && t.pop(), r = w, s = b, p = L + i.length, b && (c = u.bd = t[r] = []), w + ":") : w ? w.split("^").join(".").replace(ue, q) + (T ? (u = d[++h] = {
                        bd: []
        ...
        function L(e, t, n) {
            var i, r, o, s, a, l, c, u, d, p, f, h, g, v, m, y, b, w, x, _, $, k, C, S, A, E, O, N, P, R, q = 0,
                ...
                F = {},
                U = e.length;
            for ("" + t === t ? (w = n ? 'data-link="' + t.replace(pe, " ").slice(1, -1) + '"' : t, t = 0) : (w = t.tmplName || "unnamed", t.allowCode && (F.allowCode = !0), t.debug && (F.debug = !0), f = t.bnds, b = t.tmpls), i = 0; U > i; i++)
                if (r = e[i], "" + r === r) H += '\n+"' + r + '"';
                else if (o = r[0], "*" === o) H += ";\n" + r[1] + "\nret=ret";
            else {
        ...
        function M(e) {
            var t, n, i = [];
            if (typeof e === Te)
                for (t in e) n = e[t], n && n.toJSON && !n.toJSON() || J(n) || i.push({
                    key: t,
                    prop: n
                });
            return i
        ...
        function F(e) {
            return void 0 != e ? be.test(e) && ("" + e).replace(xe, q) || e : ""
        }
        var U = (0, eval)("this"),
            z = e === !1;
        e = e && e.fn ? e : U.jQuery;
        var W, B, V, Y, X, J, G, K, Q, Z, ee, te, ne, ie, re = "v1.0.0-beta",
            oe = "{",
            se = "{",
            ae = "}",
            le = "}",
        ...
        if (X = {
            ...
            K = X.templates, Q = X.converters, Z = X.helpers, ee = X.tags, te = X.sub, ne = X.settings, te._tg.prototype = {
                baseApply: _,
                cvtArgs: v
            }, Y = te.topView = new b, e ? (e.fn.render = H, e.observable && (c(te, e.views.sub), X.map = e.views.map)) : (e = {}, z && (U.jsrender = e), e.renderFile = e.__express = e.compile = function() {
            ...
            }, e.jsrender = re), J = e.isFunction, G = e.isArray, e.render = Ee, e.views = X, e.templates = K = X.templates, ne({
                debugMode: a,
                delimiters: u,
                onError: function(e, t, n) {
                    return t && (e = void 0 === n ? "{Error: " + (e.message || e) + "}" : J(n) ? n(e, t) : n), void 0 == e ? "" : e
                },
                _dbgMode: !1
            }), ee({
                "if": {
    ...
    function(e) {
                ...
                inline: {
                    ...
                    "[": function k(e) {
                        ...
                        if (1 === l.length && "string" == typeof l[0]) {
                            var g = l[0].toLowerCase().replace(/\s+/, " ");
                            return s = {
                                ref: g,
                                original: r.substr(0, a)
        ...
        $.processMetaHash = function(e) {
            ...
            return y(n[3].replace(/\|\s*$/gm, "").split("\n"), function(e) {
                var n = ["tr"];
        ...
        var t = function() {
                ...
                return function() {
                        if (!t || !t.requirejs) {
                            ...
                            ! function(t) {
                                ...
                                function o(e, t) {
                                    ...
                                    if (e && "." === e.charAt(0))
                                        if (t) {
                                            for (e = e.split("/"), s = e.length - 1, y.nodeIdCompat && _.test(e[s]) && (e[s] = e[s].replace(_, "")), e = f.slice(0, f.length - 1).concat(e), u = 0; u < e.length; u += 1)
                                        ...
                                        for (n = e.split("/"), u = n.length; u > 0; u -= 1) {
                                            if (i = n.slice(0, u).join("/"), f)
                                                for (d = f.length; d > 0; d -= 1)
                                                    if (r = h[f.slice(0, d).join("/")], r && (r = r[i])) {
                                                        o = r, a = u;
                                                        break
                                                    }
                                            if (o) break;
                                ...
                                h = function(e, t) {
                                    ...
                                    if ("string" == typeof e) return g[e] ? g[e](n) : c(h(e, n).f);
                                    if (!e.splice) {
                        ...
                        return n.prototype.bind = function(e, t, n) {
                            ...
                            var f = p.offset();
                            d.top -= f.top, d.left -= f.left, n || i || (r = "below"), u || !c || n ? !c && u && n && (r = "below") : r = "above", ("above" == r || n && "below" !== r) && (d.top = s.top - a.height), null != r && (this.$dropdown.removeClass("select2-dropdown--below select2-dropdown--above").addClass("select2-dropdown--" + r), this.$container.removeClass("select2-container--below select2-container--above").addClass("select2-container--" + r)), this.$dropdownContainer.css(d)
                    ...
                    function(n) {
                        ...
                        function t(t) {
                            ...
                            if (t = e.event.fix(s), t.type = "mousewheel", "detail" in s && (p = -1 * s.detail), "wheelDelta" in s && (p = s.wheelDelta), "wheelDeltaY" in s && (p = s.wheelDeltaY), "wheelDeltaX" in s && (d = -1 * s.wheelDeltaX), "axis" in s && s.axis === s.HORIZONTAL_AXIS && (d = -1 * p, p = 0), c = 0 === p ? d : p, "deltaY" in s && (p = -1 * s.deltaY, c = p), "deltaX" in s && (d = s.deltaX, 0 === p && (c = -1 * d)), 0 !== p || 0 !== d) {
                                ...
                                return t.deltaX = d, t.deltaY = p, t.deltaFactor = o, t.offsetX = h, t.offsetY = g, t.deltaMode = 0, a.unshift(t, c, d, p), r && clearTimeout(r), r = setTimeout(n, 200), (e.event.dispatch || e.event.handle).apply(this, a)
                            }
                        }
...
_.templateSettings = {
    ...
    $("[data-sms]").each(function(e) {
        /iPhone|iPad|iPod/i.test(navigator.userAgent) ? $(this).attr("href", "sms:0644630404&body=" + $(this).attr("data-sms")) : $(this).attr("href", "sms:0644630404?body=" + $(this).attr("data-sms"))
    }), $("[markdown-remote]").each(function(e) {
        var t = $(this).attr("markdown-remote"),
            n = $(this),
            i = $.ajax({
                url: t,
                method: "GET"
    ...
    }), $("[data-track-offer]").each(function(e) {
        var t = $(this).attr("data-track-offer"),
            n = $(this);
        n.on("click", function() {
    ...
    if (0 !== $("body.commandes").length) {
        ...
        $.ajax({
            ...
            $(".panel-group").append(e.render(n))
        })
    }
});
var baseTimeoutInterval = 3e3,
    numberOfMessagesByExample = 1,
    examples = [{
        headline: "ce que tu veux",
        messages: ["Bonjour Antony! Je suis Solo, ton assistant de voyage RATP. De quoi as-tu besoin? Itinéraire, Tarifs, une urgence ou autre chose? ", "Un itinéraire!", "Super :) Ou es tu ? ", "Gare de Lyon", "Ok. Et tu veux aller?", "Saint mandé", ]
    }, {
        ...
        headline: "le stage de tes r\xeaves",
        messages: ["Il faut que je me bouge... Jam trouve-moi un stage please !!!", "Relax, je m'occupe de toi :) As-tu un domaine en t\xeate ?", "En agence de communication ce serait le r\xeave \ud83d\ude29 ", "BETC cherche son prochain Assistant de prod : hij.am/stage1i620r"]
    }, {
        ...
        messages: ["Tu sais ou sortir ce soir pr\xe8s de l'ESCP ?", "Je te propose Le Panic Room au 101 rue Amelot: hij.am/foo92hqz27", "Merci Jam, je vais tester !", "Ravi de t'avoir aid\xe9. Bois un coup \xe0 ma sant\xe9 \ud83c\udf7b "]
    }],
    formations = [{
        id: "Autre",
        text: "Autre"
    ...
    user;
$(document).ready(function() {
    trackEvent("Page", "ready", "Visit homepage"), 0 !== $("body.index").length && (carousel(), showFooterOnScroll(), arrowClickScroll(), initializeAnalyticsTracking(), $("form#extra_informations").submit(function(e) {
        if (e.preventDefault(), !user) return !1;
        var t = $(this),
            n = t.find(".school").val()[0],
            i = t.find(".diploma").val();
        $(".school").prop("disabled", !0), $(".diploma").prop("disabled", !0), trackEvent("Registration", "perform", "Send extra informations");
        var r = $.ajax({
        ...
        r.done(function() {
            $(".school").prop("disabled", !1), $(".diploma").prop("disabled", !1), $("#myModal").modal("hide")
        }), r.fail(function() {
            $(".school").prop("disabled", !1), $(".diploma").prop("disabled", !1)
        })
    }), $("form#user_registration").submit(onUserRegistration), $("form#user_registration_footer").submit(onUserRegistration))
});
